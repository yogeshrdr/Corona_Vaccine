...
class Forms extends Component {
 ...
 render(){
   ...
   if(this.state.reference_Id === "1234"){
       hello = (
         <div>
            <PageTitle>Manufacturer Delete</PageTitle>
...
<Card>
  <CardBody>
    <p className="mb-10 font-bold text-black dark:text-gray-300">Manufacturer ID - 123R567AB</p>
      <div className="grid gap-4 mb-8 md:grid-cols-4">
        <p className="mb-4 font-bold text-black dark:text-gray-300">Manufacturer Name - covaxin Maufaturer pvt.ltd</p>
  ...
  return (
    <>
      <PageTitle >Search Manufacturer Delete</PageTitle>
